...
class Custom_API_Creator
{
    ...
    private function render_section_fields($post_types, $all_taxonomies, $index, $section = null)
    {
        ...
        ?>
        <div class="api-section" data-index="<?php echo $index; ?>">
            ...
            <p>
                ...
                foreach ($available_fields as $field):
                    ...
                    ?>
                    <label><input type="checkbox" name="custom_api_sections[<?php echo $index; ?>][fields][]"
            ...
            <p>
                ...
                <?php foreach ($all_taxonomies as $tax):
                    ...
                    ?>
                    <label><input type="checkbox" name="custom_api_sections[<?php echo $index; ?>][taxonomies][]"
    ...
    public function save_custom_api_meta($post_id)
    {
        ...
        if (!wp_verify_nonce($_POST['custom_api_meta_box_nonce'], 'custom_api_meta_box')) {
            return;
        }
    ...
    public function custom_column_content($column, $post_id)
    {
        switch ($column) {
            case 'endpoint':
                ...
                if ($endpoint) {
                    echo esc_html(home_url('/wp-json/custom-api/v1/' . ltrim($endpoint, '/')));
                } else {
                    echo '—';
                }
                break;
            ...
            case 'permission':
                ...
                if ($access_type === 'public') {
                    echo __('Public', 'custom-api-creator');
                } else {
                    ...
                    if (!empty($roles)) {
                        ...
                        echo __('No roles specified', 'custom-api-creator');
                    }
                }
                break;
        }
